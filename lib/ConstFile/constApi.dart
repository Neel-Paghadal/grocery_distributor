class ConstApi {
  static const String baseUrl = 'http://208.64.33.118/ECommerce/api/';
  static const String Login = '${baseUrl}DistiButer/Get_DistiButer_Login';
  static const String assignOrder = '${baseUrl}DistiButer/Get_DistiButer_AssignOrderList';
