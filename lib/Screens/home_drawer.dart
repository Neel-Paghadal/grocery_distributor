...
import 'package:grocery_distributor/Screens/stockRequest_screen.dart';
        ...
        children: [
          Padding(
            padding: EdgeInsets.only(
                top: deviceHeight * 0.06, bottom: deviceHeight * 0.02),
            child: InkWell(
              onTap: () {
                Get.back();
                    ...
                    Expanded(
                      ...
                      children: [
                        ListTile(
                          ...
                          leading: (myProfileController.userProfileImage ==
                                      null ||
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Get.to(() => const BottomBarScreen(),
                  arguments: {homeController.currentIndex = 3});
            },
            title: const Text(
              "User List",
              style: TextStyle(
