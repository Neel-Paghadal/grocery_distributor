...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        homeController.showExitAlertDialog(context);
        return false;
      },
      // onWillPop: () async {
      //   if (count >= 2) {
      ...
      //     //   content: Text('Click again to close app'),
                ...
                children: [
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      myProfileController
                                              .totalStockCount.value.isNotEmpty
                                          ? myProfileController
                                              .totalStockCount.value
                                              .toString()
                                          : '0.0',
                                      style: TextStyle(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      myProfileController
                                              .lowStockCount.value.isNotEmpty
                                          ? myProfileController
                                              .lowStockCount.value
                                              .toString()
                                          : "0.0",
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Obx(
                        () => homeController.liveOrderList.isEmpty
                            ? Center(child: Text("No Data Avaliable"))
                            : ListView.builder(
                                shrinkWrap: true,
