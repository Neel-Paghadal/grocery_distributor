...
class _GodownScreenState extends State<GodownScreen> {
  GodownStockController godownStockController =
      Get.put(GodownStockController());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() => godownStockController.godownStockList.isEmpty
          ? Loaders(
              items: 8,
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                    "Stock In\n${godownStockController.godownStockList[index].stockIn}Pic",
                                                    style: TextStyle(
                                                        fontSize: 12,
                                                  ...
                                                  Text(
                                                    "Stock Out\n${godownStockController.godownStockList[index].stockOut}Pic",
                                                    style: TextStyle(
                                                        fontSize: 12,
                                                        fontFamily: ConstFont
                                                            .popinsRegular,
                                                  ...
                                                  Text(
                                                    "Total Stock\n${godownStockController.godownStockList[index].totalStock}Pic",
                                                    style: TextStyle(
                                                        fontSize: 12,
                                                        fontFamily: ConstFont
                                                            .popinsRegular,
