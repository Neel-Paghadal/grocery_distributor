...
class _LowStockScreenState extends State<LowStockScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: Obx(() => lowStockController.lowStockList.isEmpty
            ? Loaders(
                items: 8,
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      "Stock In\n${lowStockController.lowStockList[index].stockIn}Pic",
                                                      style: TextStyle(
                                                          fontSize: 12,
                                                          fontFamily: ConstFont
                                                              .popinsRegular,
                                                    ...
                                                    Text(
                                                      "Stock Out\n${lowStockController.lowStockList[index].stockOut}Pic",
                                                      style: TextStyle(
                                                          fontSize: 12,
                                                          fontFamily: ConstFont
                                                              .popinsRegular,
                                                    ...
                                                    Text(
                                                      "Total Stock\n${lowStockController.lowStockList[index].totalStock}Pic",
                                                      style: TextStyle(
                                                          fontSize: 12,
                                                          fontFamily: ConstFont
                                                              .popinsRegular,
