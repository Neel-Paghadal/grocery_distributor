...
class _UserPageState extends State<UserPage> {
  ...
  UserOrderHistoryController userOrderHistoryController =
      Get.put(UserOrderHistoryController());
  @override
  void initState() {
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Padding(
                                padding:
                                    EdgeInsets.only(left: deviceWidth * 0.018),
                                child: const Icon(
                                  Icons.image,
                                  size: 80,
                                ),
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Padding(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          onTap: () {
                            userOrderHistoryController.customerId =
                                userListController.allUser[index].customerId
                                    .toString();
                          ...
                          leading: Image(
                            ...
                            image: NetworkImage(
                              userListController.allUser[index].customerImage
                                  .toString(),
                            ),
                            // image:  NetworkImage(
